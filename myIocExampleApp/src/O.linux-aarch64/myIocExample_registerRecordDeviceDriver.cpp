...
/* Generated from ../O.Common/myIocExample.dbd */
...
int myIocExample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/bomr/epics/base-3.16/myExampleApp";
...
/* myIocExample_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: myIocExample_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(myIocExample_registerRecordDeviceDriver(*iocshPpdbbase));
}
